...
const MetricasVentas = () => {
    ...
    // --- FILTROS DE FECHA AHORA CON SELECTS ---
    ...
    // Función para obtener la lista de métodos de pago desde la API (¡NUEVO!)
    const fetchPaymentMethods = useCallback(async () => {
        try {
            ...
            console.log("Fetching payment methods from:", `${process.env.REACT_APP_API_URL}/payment-methods/`);
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/payment-methods/`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
            ...
            // Si hay un error al cargar desde la API, puedes mantener los hardcodeados como fallback
            setPaymentMethods([
    ...
    const fetchMetricas = useCallback(async () => {
        ...
        try {
            ...
            let url = `${process.env.REACT_APP_API_URL}/metricas/metrics/`;
            const params = new URLSearchParams();
            if (yearFilter) params.append('year', yearFilter);
            if (monthFilter) params.append('month', monthFilter);
            if (dayFilter) params.append('day', dayFilter);
            if (selectedSellerId) params.append('usuario', selectedSellerId);
    ...
    }, [yearFilter, monthFilter, dayFilter, selectedSellerId, selectedPaymentMethod]);
        ...
        <div style={styles.container}>
            ...
            <form onSubmit={handleFilterSubmit} style={styles.formContainer}>
                ...
                <div style={styles.filterGroup}>
                    ...
                    {/* --- NUEVO SELECT PARA MÉTODO DE PAGO --- */}
                    <select
